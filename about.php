        ...
        <div class="container">
            <div class="row justify-content-between gx-0 ">
                <div class="col-md-10">
                    ...
                    <h2 class="h3 pe-xxl-5 me-xxl-5 mb-md-5 pb-xl-3">We think your skin should look and refshed matter
                        Nourish your outer inner beauty with our essential oil infused beauty should products.</h2>
                </div>
            ...
            <p class="fs-22 font-title text-title mb-4 mb-lg-5">We think your skin should look and refshed matter
                Nourish your outer inner beauty with our essential infused Lorem Ipsum is simply dummy text of the
                printing and typesetting industry. Lorem Ipsum has been industry's standard dummy text ever since the
                1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It
                has survived not only five centuries, but also the leap intoun.</p>
            <div class="row justify-content-between">
                <div class="col-xl-4 mb-3 mb-xl-0">
                    <h3 class="text-uppercase font-body mt-n1">DISCOVER <span class="text-theme">Wellnez</span> Service
                    </h3>
        ...
        <div class="container">
            ...
            <div class="testi-style2">
                ...
                <div class="vs-carousel" data-slide-show="1" data-fade="true" data-arrows="true" data-ml-arrows="true"
                    ...
                    <div>
                        <p class="testi-text">“We think your skin should look and refshed matter Nourish your outer
                    ...
                    <div>
                        <p class="testi-text">“Creation timelines for the standard lorem ipsum passage vary, with some
