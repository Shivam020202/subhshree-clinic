<?php
$page_title = "Forma Plus - SMT Skin Clinic - Advanced Radiofrequency Skin Tightening";
...
<body>
    ...
    Breadcumb
============================== -->
    <div class="breadcumb-wrapper" style="background-image: url('assets/img/banner/Body/forma-plus-skin-tightening.png');">
            ...
            <div class="breadcumb-content">
                ...
                <div class="breadcumb-menu-wrap">
                    <ul class="breadcumb-menu">
                        ...
                        <li>Forma <span class="inner-text">Plus</span></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row gx-50">
                <div class="col-lg-8 col-xl mb-30 mb-lg-0">
                    <div class="mb-30">
                        <div class="mega-hover"><img src="assets/img/service/s-d-1-1.jpg" alt="Forma Plus Treatment">
                        </div>
                    </div>
                    ...
                    <div class="mt-40 mb-30">
                        ...
                        <div class="list-style2">
                            <ul class="list-unstyled">
                                ...
                                <li>Large treatment heads for efficient coverage of body areas</li>
                                <li>Comfortable treatment with built-in cooling system</li>
                                <li>No downtime required - return to activities immediately</li>
                                <li>Safe for all skin types and suitable year-round</li>
                                <li>FDA-approved for skin tightening and body contouring</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <aside>
                        <div class="service-box">
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li><a href="forma-plus.php">Forma Plus</a></li>
                            </ul>
                        </div>
