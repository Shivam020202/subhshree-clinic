<?php
$page_title = "Microchannel Infusion Therapy | Service Details";
            ...
            <div class="breadcumb-content">
                ...
                <div class="breadcumb-menu-wrap">
                    <ul class="breadcumb-menu">
                        ...
                        <li>Microchannel Infusion Therapy</li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-8 col-xl mb-30 mb-lg-0">
                    ...
                    <div class="list-style2">
                        <ul class="list-unstyled">
                            ...
                            <li>Improves skin texture, tone, and overall appearance</li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 mb-30">
                            <div class="mega-hover"><img
                                    src="https://images.unsplash.com/photo-1612198186421-9bb12c2ccc00?q=80&w=1600&auto=format&fit=crop"
                                    alt="shape" class="w-100">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row mt-30">
                            <div class="col-md-4 mb-20">
                                <div class="text-center border border-secondary rounded p-3 m-3">
                                    <h5>Micro-Channeling</h5>
                                    <p class="small">Precise creation of microscopic pathways in the skin</p>
                                </div>
                            </div>
                            <div class="col-md-4 mb-20">
                                <div class="text-center border border-secondary rounded p-3 m-3">
                                    <h5>Serum Infusion</h5>
                                    <p class="small">Deep delivery of active ingredients and growth factors</p>
                                </div>
                            </div>
                            <div class="col-md-4 mb-20">
                                <div class="text-center border border-secondary rounded p-3 m-3">
                                    <h5>Healing Response</h5>
                                    <p class="small">Natural collagen production and tissue regeneration</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-50">
                        ...
                        <div class="list-style2 mt-20">
                            <h6>Treatment Targets:</h6>
                            <ul class="list-unstyled">
                                <li>Fine lines and wrinkles</li>
                                <li>Acne scars and textural irregularities</li>
                                <li>Enlarged pores and uneven skin tone</li>
                                ...
                                <div class="testimonial-track" id="testimonialTrack">
                                    <div class="testimonial-slide">
                                        ...
                                        <div class="testimonial-author">
                                            ...
                                            <div class="author-details">Age 32, HR Manager, Lucknow</div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="testimonial-slide">
                                        ...
                                        <div class="testimonial-author">
                                            ...
                                            <div class="author-details">Age 40, Architect, Kanpur</div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="testimonial-slide">
                                        ...
                                        <div class="testimonial-author">
                                            ...
                                            <div class="author-details">Age 45, Teacher, Allahabad</div>
                                        </div>
                                    </div>
                                </div>
