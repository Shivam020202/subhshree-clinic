<?php
$page_title = "Cellulite Reduction - SMT Skin Clinic - Advanced Body Contouring Treatment";
...
<body>
    ...
    Breadcumb
============================== -->
    <div class="breadcumb-wrapper" style="background-image: url('assets/img/banner/Body/cellulite.png');">
            ...
            <div class="breadcumb-content">
                ...
                <div class="breadcumb-menu-wrap">
                    <ul class="breadcumb-menu">
                        ...
                        <li>Cellulite <span class="inner-text">Reduction</span></li>
                    </ul>
                </div>
            </div>
        </div>
                    ...
                    <div class="mt-40 mb-30">
                        ...
                        <div class="list-style2">
                            <ul class="list-unstyled">
                                ...
                                <li>Can occur regardless of weight or fitness level</li>
                                <li>Becomes more noticeable with age as skin loses elasticity</li>
                                <li>Grades range from mild (Grade 1) to severe (Grade 3)</li>
                                <li>Multiple factors contribute to its development and severity</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <aside>
                        <div class="service-box">
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li><a href="cellulite-reduction.php">Cellulite Reduction</a></li>
                            </ul>
                        </div>
