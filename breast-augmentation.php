<?php
$page_title = "Breast Augmentation - SMT Skin Clinic - Non-Surgical Enhancement Treatments";
...
<body>
    ...
    Breadcumb
============================== -->
    <div class="breadcumb-wrapper" style="background-image: url('assets/img/banner/Body/breast-augmentation.png');">
            ...
            <div class="breadcumb-content">
                ...
                <div class="breadcumb-menu-wrap">
                    <ul class="breadcumb-menu">
                        ...
                        <li>Breast <span class="inner-text">Augmentation</span></li>
                    </ul>
                </div>
            </div>
        </div>
                    ...
                    <div class="mt-40 mb-30">
                        ...
                        <div class="list-style2">
                            <ul class="list-unstyled">
                                ...
                                <li>Injectable enhancement techniques for volume restoration</li>
                                <li>Ultrasound technology for deep tissue stimulation</li>
                                <li>Specialized massage and contouring protocols</li>
                                <li>Natural collagen stimulation for long-term improvements</li>
                                <li>Customized treatment plans based on individual goals</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <aside>
                        <div class="service-box">
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li><a href="breast-augmentation.php">Breast Augmentation</a></li>
                            </ul>
                        </div>
