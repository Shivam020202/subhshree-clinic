<?php
$page_title = "Ballancer Pro - SMT Skin Clinic - Advanced Lymphatic Drainage Therapy";
        ...
        <div class="container">
            <div class="row gx-50">
                <div class="col-lg-8 col-xl mb-30 mb-lg-0">
                    <div class="mb-30">
                        <div class="mega-hover"><img src="assets/img/service/s-d-1-1.jpg" alt="Ballancer Pro Treatment">
                        </div>
                    </div>
                    ...
                    <div class="mt-40 mb-30">
                        ...
                        <div class="list-style2">
                            <ul class="list-unstyled">
                                ...
                                <li>Sequential pressure waves that follow lymphatic pathways</li>
                                <li>Customizable pressure settings for individual needs</li>
                                <li>FDA-cleared for lymphatic drainage and circulation improvement</li>
                                <li>Comfortable, relaxing treatment experience</li>
                                <li>Suitable for various therapeutic and wellness applications</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <aside>
                        <div class="service-box">
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li><a href="ballancer-pro.php">Ballancer Pro</a></li>
                            </ul>
                        </div>
