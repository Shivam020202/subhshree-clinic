<?php
$page_title = "Tattoo Removal | SMT Skin Clinic";
        ...
        <div class="container">
            <div class="row flex-row-reverse gx-50">
                <div class="col-lg-8 col-xl mb-30 mb-lg-0">
                    ...
                    <div class="mb-50">
                        <h3 class="h4 mb-25">What is Tattoo Removal?</h3>
                        <p>Tattoo Removal treatment at SMT Skin Clinic utilizes advanced medical technology to address
                    ...
                    <div class="mb-50">
                        ...
                        <div class="list-style2 mt-20">
                            <h6>Additional Important Considerations:</h6>
                            <ul class="list-unstyled">
                                <li>Complete removal isn't always guaranteed—some fading may remain</li>
                                <li>Temporary side effects include blistering, swelling, and crusting</li>
                                <li>Risk of hyperpigmentation or hypopigmentation in treated area</li>
                                <li>Cost varies based on tattoo size, colors, and sessions required</li>
                                <li>Avoiding sun exposure before and after each session is essential</li>
                                <li>Pre-existing scarring from tattoo may become more visible post-removal</li>
                            </ul>
                        </div>
                    </div>
