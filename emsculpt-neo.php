<?php
$page_title = "Emsculpt Neo - SMT Skin Clinic - Advanced Body Sculpting and Fat Reduction";
            ...
            <div class="breadcumb-content">
                ...
                <div class="breadcumb-menu-wrap">
                    <ul class="breadcumb-menu">
                        ...
                        <li>Emsculpt <span class="inner-text">Neo</span></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row gx-50">
                <div class="col-lg-8 col-xl mb-30 mb-lg-0">
                    <div class="mb-30">
                        <div class="mega-hover"><img src="assets/img/service/s-d-1-1.jpg" alt="Emsculpt Neo Treatment">
                        </div>
                    </div>
                    ...
                    <div class="mt-40 mb-30">
                        ...
                        <div class="list-style2">
                            <ul class="list-unstyled">
                                ...
                                <li>Simultaneous fat reduction and muscle building in one treatment</li>
                                <li>30% average fat reduction and 25% muscle volume increase</li>
                                <li>FDA-approved for abdomen, buttocks, arms, and legs</li>
                                <li>No downtime required - return to activities immediately</li>
                                <li>Equivalent to 20,000 crunches or squats per session</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="mt-40 mb-30">
                        ...
                        <div class="list-style2">
                            <ul class="list-unstyled">
                                ...
                                <li><strong>Buttocks:</strong> Lifts and sculpts for enhanced shape and projection</li>
                    ...
                    <aside>
                        <div class="service-box">
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li><a href="emsculpt-neo.php">Emsculpt Neo</a></li>
                            </ul>
                        </div>
