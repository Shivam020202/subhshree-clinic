<?php
$page_title = "Resurfacing Treatment | Service Details";
...
<body>
    ...
    <div class="smt-mobile-services-menu" id="smtMobileServicesMenu">
        ...
        <div class="smt-mobile-category-wrapper">
            ...
            <div class="smt-mobile-category-services">
                ...
                <a href="laser-radio-frequency.php">Laser & Radio-frequency</a>
                <a href="resurfacing.php">Resurfacing</a>
    ...
    Breadcumb
============================== -->
    <div class="breadcumb-wrapper" style="background-image: url('assets/img/banner/smt-left-banners/resurfacing-treatment.png');">
                ...
                <div class="col-lg-8 col-xl mb-30 mb-lg-0">
                    ...
                    <div class="list-style2">
                        <ul class="list-unstyled">
                            ...
                            <li>Significant reduction in wrinkles and fine lines</li>
                            <li>Effective treatment for acne scars and sun damage</li>
                            <li>Customizable intensity based on skin needs and downtime tolerance</li>
                        </ul>
                    </div>
                    <div class="row">
                        ...
                        <div class="row mt-30">
                            <div class="col-md-4 mb-20">
                                <div class="text-center border border-secondary rounded p-3 m-3">
                                    <h5>Ablative Resurfacing</h5>
                                    <p class="small">Complete removal of skin layers for dramatic results</p>
                                </div>
                            </div>
                            <div class="col-md-4 mb-20">
                                <div class="text-center border border-secondary rounded p-3 m-3">
                                    <h5>Fractional Resurfacing</h5>
                                    <p class="small">Partial treatment patterns for faster healing</p>
                                </div>
                            </div>
                            <div class="col-md-4 mb-20">
                                <div class="text-center border border-secondary rounded p-3 m-3">
                                    <h5>Chemical Resurfacing</h5>
                                    <p class="small">Acid-based peels for controlled skin renewal</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-50">
                        ...
                        <div class="list-style2 mt-20">
                            <h6>Treatment Indications:</h6>
                            <ul class="list-unstyled">
                                <li>Deep wrinkles and expression lines</li>
                                <li>Moderate to severe acne scarring</li>
                                <li>Extensive sun damage and age spots</li>
                                <li>Rough skin texture and enlarged pores</li>
                                ...
                                <div class="testimonial-track" id="testimonialTrack">
                                    <div class="testimonial-slide">
                                        ...
                                        <div class="testimonial-author">
                                            ...
                                            <div class="author-details">Age 52, Business Executive, Lucknow</div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="testimonial-slide">
                                        ...
                                        <div class="testimonial-author">
                                            ...
                                            <div class="author-details">Age 38, Teacher, Kanpur</div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="testimonial-slide">
                                        ...
                                        <div class="testimonial-author">
                                            ...
                                            <div class="author-details">Age 46, Consultant, Allahabad</div>
                                        </div>
                                    </div>
                                </div>
