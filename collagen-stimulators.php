<?php
$page_title = "Collagen Stimulators | Service Details";
...
<body>
    ...
    Breadcumb
============================== -->
    <div class="breadcumb-wrapper" style="background-image: url('assets/img/banner/smt-left-banners/collagen.png');">
                ...
                <div class="col-lg-8 col-xl mb-30 mb-lg-0">
                    ...
                    <div class="list-style2">
                        <ul class="list-unstyled">
                            ...
                            <li>Restores facial volume and improves skin quality</li>
                            <li>Gradual, natural-looking improvements over 3-6 months</li>
                        ...
                        <div class="row mt-30">
                            <div class="col-md-4 mb-20">
                                <div class="text-center border border-secondary rounded p-3 m-3">
                                    <h5>Sculptra</h5>
                                    <p class="small">Poly-L-lactic acid that stimulates deep collagen production</p>
                                </div>
                            </div>
                            <div class="col-md-4 mb-20">
                                <div class="text-center border border-secondary rounded p-3 m-3">
                    ...
                    <div class="mb-50">
                        ...
                        <div class="list-style2 mt-20">
                            ...
                            <ul class="list-unstyled">
                                <li>Weeks 1-4: Initial volume and gradual collagen activation</li>
                                <li>Months 2-3: Progressive improvement as new collagen forms</li>
                                <li>Months 4-6: Peak results with optimal collagen remodeling</li>
                                <li>Months 6-24: Maintained results with continued collagen support</li>
                                ...
                                <div class="testimonial-track" id="testimonialTrack">
                                    <div class="testimonial-slide">
                                        ...
                                        <div class="testimonial-author">
                                            ...
                                            <div class="author-details">Age 42, Marketing Executive, Lucknow</div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="testimonial-slide">
                                        ...
                                        <div class="testimonial-author">
                                            ...
                                            <div class="author-details">Age 48, Business Owner, Kanpur</div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="testimonial-slide">
                                        ...
                                        <div class="testimonial-author">
                                            ...
                                            <div class="author-details">Age 39, Doctor, Allahabad</div>
                                        </div>
                                    </div>
                                </div>
