<?php
$page_title = "Melasma Treatment | Service Details";
...
<body>
    ...
    Breadcumb
============================== -->
    <div class="breadcumb-wrapper" style="background-image: url('assets/img/banner/Skin/melasma.png');">
                ...
                <div class="col-lg-8 col-xl mb-30 mb-lg-0">
                    ...
                    <div class="list-style2">
                        <ul class="list-unstyled">
                            ...
                            <li>Combination therapy for optimal results</li>
                            <li>Prevention strategies to minimize recurrence</li>
                            <li>Safe for all skin types with personalized approach</li>
                        </ul>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-6 mb-30">
                            <div class="mega-hover"><img
                                    src="https://images.unsplash.com/photo-1590736969955-71cc94901144?q=80&w=1600&auto=format&fit=crop"
                                    alt="shape" class="w-100">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row mt-30">
                            <div class="col-md-4 mb-20">
                                <div class="text-center border border-secondary rounded p-3 m-3">
                                    <h5>Centrofacial</h5>
                                    <p class="small">Forehead, cheeks, nose, upper lip, and chin</p>
                                </div>
                            </div>
                            <div class="col-md-4 mb-20">
                                <div class="text-center border border-secondary rounded p-3 m-3">
                                    <h5>Malar</h5>
                                    <p class="small">Cheeks and nose in a butterfly pattern</p>
                                </div>
                            </div>
                            <div class="col-md-4 mb-20">
                                <div class="text-center border border-secondary rounded p-3 m-3">
                                    <h5>Mandibular</h5>
                                    <p class="small">Jawline and chin area</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-50">
                        ...
                        <div class="list-style2 mt-20">
                            ...
                            <ul class="list-unstyled">
                                <li>Thyroid dysfunction and autoimmune conditions</li>
                                <li>Certain cosmetics and skincare products</li>
                                <li>Anti-seizure medications and some antibiotics</li>
                                <li>Heat exposure and inflammatory skin conditions</li>
                                <li>Stress and sleep disruption affecting hormonal balance</li>
                            </ul>
                        </div>
                                ...
                                <div class="testimonial-track" id="testimonialTrack">
                                    <div class="testimonial-slide">
                                        ...
                                        <div class="testimonial-author">
                                            ...
                                            <div class="author-details">Age 34, Mother of Two, Lucknow</div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="testimonial-slide">
                                        ...
                                        <div class="testimonial-author">
                                            ...
                                            <div class="author-details">Age 38, Bank Manager, Kanpur</div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="testimonial-slide">
                                        ...
                                        <div class="testimonial-author">
                                            ...
                                            <div class="author-details">Age 41, Professor, Allahabad</div>
                                        </div>
                                    </div>
                                </div>
