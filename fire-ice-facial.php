<?php
$page_title = "Fire & Ice Facial - SMT Skin Clinic";
$page_description = "SMT Clinic - Your Health, Our Priority";
$page_keywords = "fire and ice facial, resurfacing facial, red carpet facial, skin rejuvenation, instant glow";
?>
<!doctype html>
        ...
        <div class="container">
            <div class="row flex-row-reverse gx-50">
                <div class="col-lg-8 col-xl mb-30 mb-lg-0">
                    <div class="mb-30">
                        <div class="mega-hover"><img src="assets/img/service/fire-ice-main.jpg"
                    ...
                    <div class="list-style2">
                        <ul class="list-unstyled">
                            <li>Instant visible results - no downtime</li>
                            <li>Intensive resurfacing treatment</li>
                            <li>Safe for all skin types</li>
                            <li>Clinical-grade professional products</li>
                    ...
                    <div class="row">
                        <div class="col-6 mb-30">
                            <div class="mega-hover"><img src="assets/img/service/fire-ice-before.jpg"
                                    alt="Before Treatment" class="w-100"></div>
                        </div>
                        <div class="col-6 mb-30">
                            <div class="mega-hover"><img src="assets/img/service/fire-ice-after.jpg"
