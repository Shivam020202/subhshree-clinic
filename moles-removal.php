...
<body>
    ...
    Breadcumb
============================== -->
    <div class="breadcumb-wrapper " data-bg-src="assets/img/banner/Laser/mole-removal.png">
                ...
                <div class="col-lg-8 col-xl mb-30 mb-lg-0">
                        ...
                        <div class="row mt-30">
                            <div class="col-md-4 mb-20">
                                <div class="text-center border border-secondary rounded p-3 m-3">
                                    <h5>Surgical Excision</h5>
                                    <p class="small">Complete removal with histopathology</p>
                                </div>
                            </div>
                            <div class="col-md-4 mb-20">
                                <div class="text-center border border-secondary rounded p-3 m-3">
                                    <h5>Shave Removal</h5>
                                    <p class="small">Surface-level removal for raised moles</p>
                                </div>
                            </div>
                            <div class="col-md-4 mb-20">
                                <div class="text-center border border-secondary rounded p-3 m-3">
                                    <h5>Laser Ablation</h5>
                                    <p class="small">Non-invasive option for suitable moles</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-50">
                        ...
                        <div class="list-style2 mt-20">
                            <h6>Additional Indications for Removal:</h6>
                            <ul class="list-unstyled">
                                <li>Bleeding, itching, or painful moles</li>
                                <li>Moles that interfere with daily activities</li>
                                <li>New moles appearing after age 30</li>
                                <li>Moles in difficult-to-monitor locations</li>
                                <li>Patient preference for peace of mind</li>
                            </ul>
                        </div>
                                ...
                                <div class="testimonial-track" id="testimonialTrack">
                                    <div class="testimonial-slide">
                                        ...
                                        <div class="testimonial-author">
                                            <div class="author-name">Pooja Saxena</div>
                                            <div class="author-details">Age 29, HR Professional, Lucknow</div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="testimonial-slide">
                                        ...
                                        <div class="testimonial-author">
                                            <div class="author-name">Arjun Mishra</div>
                                            <div class="author-details">Age 36, Sales Manager, Kanpur</div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="testimonial-slide">
                                        ...
                                        <div class="testimonial-author">
                                            <div class="author-name">Divya Sinha</div>
                                            <div class="author-details">Age 42, Lawyer, Allahabad</div>
                                        </div>
                                    </div>
                                </div>
