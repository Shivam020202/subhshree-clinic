...
$page_keywords = "cheek augmentation, cheek fillers, facial contouring, cheek enhancement, facial volume";
?>
<!doctype html>
                ...
                <div class="col-lg-8 col-xl mb-30 mb-lg-0">
                    ...
                    <div class="list-style2">
                        <ul class="list-unstyled">
                            <li>FDA-approved premium dermal fillers</li>
                            <li>Immediate, natural-looking volume restoration</li>
                            <li>Minimal downtime and discomfort</li>
                            <li>Customized treatment plans for facial harmony</li>
                            <li>Long-lasting results (12-18 months)</li>
                        </ul>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-6 mb-30">
                            <div class="mega-hover"><img src="assets/img/service/cheek-before.jpg"
                                    alt="Before Treatment" class="w-100"></div>
                        </div>
                        <div class="col-6 mb-30">
                            <div class="mega-hover"><img src="assets/img/service/cheek-after.jpg"
