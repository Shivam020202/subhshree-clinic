<?php
$page_title = "Facial Sculpting - SMT Skin Clinic";
$page_description = "SMT Clinic - Refine your features with advanced Facial Sculpting treatments";
$page_keywords = "clinic, health, wellness, medical, treatment, care, therapy, doctor, hospital, healthcare, facial sculpting, contouring, cosmetic treatment, non-surgical facelift";
?>
<!doctype html>
        ...
        <div class="container">
            <div class="row flex-row-reverse gx-50">
                <div class="col-lg-8 col-xl mb-30 mb-lg-0">
                    <div class="mb-30">
                        <div class="mega-hover"><img src="assets/img/service/facial-sculpting-main.jpg"
                    ...
                    <div class="list-style2">
                        <ul class="list-unstyled">
                            <li>FDA-approved injectable fillers and contouring agents</li>
                            <li>Customizable treatments for cheekbones, jawline, and chin</li>
                            <li>Non-surgical and minimally invasive procedures</li>
                            <li>Immediate and natural-looking results</li>
                            <li>Long-lasting effects ranging from 6 to 18 months</li>
                        </ul>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-6 mb-30">
                            <div class="mega-hover"><img src="assets/img/service/facial-sculpting-before.jpg"
                                    alt="Before Facial Sculpting" class="w-100"></div>
                        </div>
                        <div class="col-6 mb-30">
                            <div class="mega-hover"><img src="assets/img/service/facial-sculpting-after.jpg"
                    ...
                    <aside class="sidebar-area">
                        <div class="widget widget_categories   ">
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="service-details-facial-sculpting.html">Facial Sculpting</a>
                                </li>
                                <li>
