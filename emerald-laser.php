<?php
$page_title = "Emerald Laser - SMT Skin Clinic - Advanced Low-Level Laser Fat Reduction";
            ...
            <div class="breadcumb-content">
                ...
                <div class="breadcumb-menu-wrap">
                    <ul class="breadcumb-menu">
                        ...
                        <li>Emerald <span class="inner-text">Laser</span></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row gx-50">
                <div class="col-lg-8 col-xl mb-30 mb-lg-0">
                    <div class="mb-30">
                        <div class="mega-hover"><img src="assets/img/service/s-d-1-1.jpg" alt="Emerald Laser Treatment">
                        </div>
                    </div>
                    ...
                    <div class="mt-40 mb-30">
                        ...
                        <div class="list-style2">
                            <ul class="list-unstyled">
                                ...
                                <li>Photobiomodulation technology for natural fat cell response</li>
                                <li>FDA-cleared for circumference reduction without surgery</li>
                                <li>No pain, no downtime, no side effects</li>
                                <li>Suitable for all skin types and body areas</li>
                                <li>Clinically proven results in multiple studies</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <aside>
                        <div class="service-box">
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li><a href="emerald-laser.php">Emerald Laser</a></li>
                            </ul>
                        </div>
