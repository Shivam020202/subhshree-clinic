<?php
$page_title = "Hip Augmentation - SMT Skin Clinic - Non-Surgical Hip Enhancement";
...
<body>
    ...
    Breadcumb
============================== -->
    <div class="breadcumb-wrapper" style="background-image: url('assets/img/banner/Body/hip-augmentation2.png');">
            ...
            <div class="breadcumb-content">
                ...
                <div class="breadcumb-menu-wrap">
                    <ul class="breadcumb-menu">
                        ...
                        <li>Hip <span class="inner-text">Augmentation</span></li>
                    </ul>
                </div>
            </div>
        </div>
                    ...
                    <div class="mt-40 mb-30">
                        ...
                        <div class="list-style2">
                            <ul class="list-unstyled">
                                ...
                                <li>Fat transfer procedures for natural augmentation</li>
                                <li>Radiofrequency treatments for skin tightening and contouring</li>
                                <li>Specialized injection protocols for optimal shape creation</li>
                                <li>Body contouring technologies for comprehensive enhancement</li>
                                <li>Customized treatment plans based on body type and goals</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <aside>
                        <div class="service-box">
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li><a href="hip-augmentation.php">Hip Augmentation</a></li>
                            </ul>
                        </div>
