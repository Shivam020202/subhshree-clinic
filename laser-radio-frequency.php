<?php
$page_title = "Laser & Radio-frequency | Service Details";
                ...
                <div class="col-lg-8 col-xl mb-30 mb-lg-0">
                    ...
                    <div class="list-style2">
                        <ul class="list-unstyled">
                            ...
                            <li>Simultaneous surface and deep tissue treatment</li>
                            <li>Improved skin texture, tone, and firmness</li>
                            <li>Minimal downtime with progressive, long-lasting results</li>
                        </ul>
                    </div>
                    <div class="row">
                    ...
                    <div class="mb-50">
                        ...
                        <div class="row mt-30">
                            ...
                            <div class="col-md-6 mb-20">
                                <div class="text-center border border-secondary rounded p-3 m-3">
                                    <h5>Radiofrequency Energy</h5>
                                    <p class="small">Deep heating for collagen stimulation and skin tightening</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-50">
                        ...
                        <div class="list-style2 mt-20">
                            <h6>Treatment Benefits:</h6>
                            <ul class="list-unstyled">
                                <li>Comprehensive skin rejuvenation in fewer sessions</li>
                                <li>Improved skin texture, tone, and elasticity</li>
                                <li>Reduction in fine lines, wrinkles, and pore size</li>
                                <li>Enhanced skin firmness and tightening</li>
                                <li>Better treatment tolerance and shorter recovery</li>
                                <li>Long-lasting results with progressive improvement</li>
                            </ul>
                        </div>
                                ...
                                <div class="testimonial-track" id="testimonialTrack">
                                    <div class="testimonial-slide">
                                        ...
                                        <div class="testimonial-author">
                                            ...
                                            <div class="author-details">Age 44, Interior Designer, Lucknow</div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="testimonial-slide">
                                        ...
                                        <div class="testimonial-author">
                                            ...
                                            <div class="author-details">Age 36, Finance Professional, Kanpur</div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="testimonial-slide">
                                        ...
                                        <div class="testimonial-author">
                                            ...
                                            <div class="author-details">Age 38, Entrepreneur, Allahabad</div>
                                        </div>
                                    </div>
                                </div>
