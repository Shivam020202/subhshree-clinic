    ...
    <div class="breadcumb-wrapper " data-bg-src="assets/img/banner/Skin/rosacea.png">
        <div class="container z-index-common">
            <div class="breadcumb-content">
                ...
                <h1 class="breadcumb-title">Rosacea <span class="inner-text">Treatment</span></h1>
                <div class="breadcumb-menu-wrap">
                    <ul class="breadcumb-menu">
                        <li><a href="index-3.html">Home</a></li>
                        <li><a href="#">Services</a></li>
                        <li>Rosacea <span class="inner-text">Treatment</span></li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-8 col-xl mb-30 mb-lg-0">
                    ...
                    <div class="list-style2">
                        <ul class="list-unstyled">
                            ...
                            <li>Targets and eliminates visible blood vessels and spider veins</li>
                            <li>Decreases inflammatory papules and pustules</li>
                            <li>Minimizes skin sensitivity and burning sensations</li>
                            <li>Provides long-term management and prevention of flare-ups</li>
                        </ul>
                    </div>
                    <div class="row">
                        ...
                        <div class="row mt-30">
                            <div class="col-md-4 mb-20">
                                <div class="text-center border border-secondary rounded p-3 m-3">
                                    <h5>IPL Therapy</h5>
                                    <p class="small">Targets redness and visible blood vessels</p>
                                </div>
                            </div>
                            <div class="col-md-4 mb-20">
                                <div class="text-center border border-secondary rounded p-3 m-3">
                                    <h5>Laser Treatment</h5>
                                    <p class="small">Precision vascular lesion removal</p>
                                </div>
                            </div>
                            <div class="col-md-4 mb-20">
                                <div class="text-center border border-secondary rounded p-3 m-3">
                                    <h5>Medical Therapy</h5>
                                    <p class="small">Prescription topicals and anti-inflammatories</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-50">
                        ...
                        <div class="list-style2 mt-20">
                            ...
                            <ul class="list-unstyled">
                                <li>Demodex folliculorum mites (naturally present but higher in rosacea skin)</li>
                                <li>H. pylori bacterial infection (associated with some cases)</li>
                                <li>Compromised skin barrier function and increased sensitivity</li>
                                <li>Hormonal fluctuations, particularly during menopause</li>
                                ...
                                <div class="testimonial-track" id="testimonialTrack">
                                    <div class="testimonial-slide">
                                        ...
                                        <div class="testimonial-author">
                                            ...
                                            <div class="author-details">Age 39, Lucknow, HR Manager</div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="testimonial-slide">
                                        ...
                                        <div class="testimonial-author">
                                            ...
                                            <div class="author-details">Age 44, Varanasi, Professor</div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="testimonial-slide">
                                        ...
                                        <div class="testimonial-author">
                                            ...
                                            <div class="author-details">Age 37, Prayagraj, Entrepreneur</div>
                                        </div>
                                    </div>
                                </div>
